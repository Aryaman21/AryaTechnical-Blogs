...
export default function Codeforces() {
  ...
  const[paths,setPaths] = useState('/codeforces');
  ...
  useEffect(()=>{
    db.collection('codeforces').onSnapshot(snapshot=>{
  ...
  return (
    <>
      <CssBaseline />
      <AppBar style={{ background:'#cccc00' }}  position="static">
        <Toolbar>
        ...
        {isOpen && <Popup
          ...
          />}
      {/* Footer */}
      <footer className={classes.footer} style={{background:"#cccc00",color:"white"}}>
