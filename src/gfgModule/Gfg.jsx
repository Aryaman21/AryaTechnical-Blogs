...
export default function Gfg() {
  ...
  const[paths,setPaths] = useState('/gfg');
  ...
  useEffect(()=>{
    db.collection('gfg').onSnapshot(snapshot=>{
  ...
  return (
    <div>
      <CssBaseline />
      <AppBar style={{background:'#00994d' }}  position="static">
        <Toolbar>
        ...
        <main style={{display:"flex",  alignItems:"center",justifyContent:"center"}}>
            ...
            <Grid container spacing={2} alignItems="center" justify="center">
                ...
                <div style={{backgroundColor:"white",border:"5px solid black",padding:"1px",borderRadius:"8px"}} className={classes.card}>
                    <div  style={{ display:"flex",justifyContent:"center",color:"white", alignItems:"center", background:'#00994d' }} position="static">
                        <Toolbar>
                        <Typography  variant="h6" color="inherit" noWrap>
        ...
        {isOpen && <Popup
          ...
          />}
      {/* Footer */}
      <footer className={classes.footer} style={{background:"#00994d",color:"white"}}>
